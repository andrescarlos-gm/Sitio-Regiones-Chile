...
["Región Metropolitana de Santiago", "img/7.jpg", "1. Cerro Santa Lucía · 2. Universidad de Chile · 3. Museo de la Memoria y los Derechos Humanos"],
...
function tarjetaRegion(valor) {
   ...
   switch (valor) {
      ...
      case 14:
         ...
         break;
      case 15:
         titulo.innerText = array1[14][0];
         document.getElementById("imagenRegion").src = array1[14][1];
         atractivos.innerHTML = array1[14][2];
         break;
      case 16:
         titulo.innerText = array1[15][0];
         document.getElementById("imagenRegion").src = array1[15][1];
         atractivos.innerHTML = array1[15][2];
         break;
   }
}
